...
//     version 1.18.0
//     from Assets/Player3rdPersonControl.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Player3rdPersonControl.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Player3rdPersonControl: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @Player3rdPersonControl()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""Player3rdPersonControl"",
    ""maps"": [
        {
            ""name"": ""PlayerMove"",
    ...
    {
        UnityEngine.Debug.Assert(!m_PlayerMove.enabled, "This will cause a leak and performance issues, Player3rdPersonControl.PlayerMove.Disable() has not been called.");
    }
    ...
    {
        private @Player3rdPersonControl m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerMoveActions(@Player3rdPersonControl wrapper) { m_Wrapper = wrapper; }
        /// <summary>
